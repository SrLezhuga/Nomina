<nav class="navbar navbar-inverse fixed-top" id="sidebar-wrapper" role="navigation">
    <ul class="nav sidebar-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu animated fadeInLeft" role="menu">
                <div class="dropdown-header">Menú Asistencias</div>
                <li><a href="capturar">Capturar</a></li>
                <li><a href="asistencias">Semanal</a></li>
            </ul>
        </li>
        <li class="dropdown">
            <a href="#works" class="dropdown-toggle" data-toggle="dropdown">
        ...
        <li class="dropdown">
            <a href="#works" class="dropdown-toggle" data-toggle="dropdown">
                <i class="fas fa-child"></i> Puesto <span class="caret"></span></a>
            <ul class="dropdown-menu animated fadeInLeft" role="menu">
                <div class="dropdown-header">Menú Puesto</div>
                <li><a href="altaPuesto">Alta Puesto</a></li>
                <li><a href="listaPuesto">Lista Puesto</a></li>
            </ul>
        </li>
        <li class="dropdown">
            <a href="#works" class="dropdown-toggle" data-toggle="dropdown">
        ...
        <li class="dropdown">
            <a href="#works" class="dropdown-toggle" data-toggle="dropdown">
                <i class="fas fa-money-bill"></i> Sueldo <span class="caret"></span></a>
            <ul class="dropdown-menu animated fadeInLeft" role="menu">
                <div class="dropdown-header">Menú Sueldo</div>
                <li><a href="altaSueldo">Alta Sueldo</a></li>
                <li><a href="listaSueldo">Lista Sueldo</a></li>
            </ul>
        </li>
        <li class="dropdown">
            <a href="#works" class="dropdown-toggle" data-toggle="dropdown">
                <i class="fas fa-file-invoice-dollar"></i> Nómina <span class="caret"></span></a>
            <ul class="dropdown-menu animated fadeInLeft" role="menu">
